...
const makeSkillCard = (item, index) => {
  return (
    <Reveal key={index} index={index}>
      <div className="w-48 bg-white shadow-sm max-sm:w-36 flex flex-row m-4 max-sm:m-2 justify-between items-center px-4 py-3 border-black text-lg max-sm:text-base rounded-md hover:scale-110 ease-in-out duration-200 hover:shadow-lg">
